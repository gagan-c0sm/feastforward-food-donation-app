// ─────────────────────────────────────────────────────────────────────────────
// Decorators.tsx — organic SVG shapes mirroring the template design language
// Use these throughout pages to add visual richness.
// ─────────────────────────────────────────────────────────────────────────────
...
/** Gold asterisk / star-burst (template's mustard-yellow asterisk) */
export function GoldAsterisk({ className = "", size = 48, opacity = 1 }: DecoratorProps) {
  return (
    <svg
      ...
      style={{ opacity }}
    >
      {/* 8-pointed asterisk via thick rotated bars */}
...
/** Dark green wavy leaf (template's top-right decorative leaf) */
...
/** Medium green herb / basil leaf (template bottom-right leaf) */
...
/** Light green half-circle (template's left-edge semi-circle) */
...
/** Small scattered leaf for card decoration */
...
/** Orange donut circle (template's nav orange ring) */
