...
import {
  ...
  ChevronRight, Heart, Package, MapPin,
  ArrowUpRight, Users, Store, Star, Leaf,
} from "lucide-react";
...
export function DashboardPage() {
  ...
  const getStats = () => {
    switch (user?.role) {
      case "donor":
        return [
          { label: "Food Donated",   value: "450kg",  icon: Package,       color: "var(--primary)",      bg: "var(--green-50)" },
          { label: "People Served",  value: "1,200",  icon: Users,         color: "var(--primary-dark)", bg: "var(--green-50)" },
          { label: "Active Posts",   value: "3",      icon: Store,         color: "var(--accent)",       bg: "var(--gold-100)" },
        ];
      case "receiver":
        return [
          { label: "Active Requests", value: "2",     icon: Users,         color: "var(--primary)",      bg: "var(--green-50)" },
      ...
      case "volunteer":
        return [
          { label: "Deliveries",        value: "24",   icon: CheckCircle2, color: "var(--primary)",      bg: "var(--green-50)" },
