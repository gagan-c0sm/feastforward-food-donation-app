...
import { FileText, Calendar, Clock, CheckCircle2, AlertCircle, Plus, ArrowRight, Leaf } from "lucide-react";
  ...
  return (
    <div className="flex-1 overflow-auto p-4 lg:p-8 relative" style={{ backgroundColor: "var(--background)" }}>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {/* Contract cards */}
        {loading ? (
          <div className="text-center py-20 text-sm font-medium" style={{ color: "var(--muted-foreground)" }}>Loading contracts...</div>
        ) : (
