...
export function AppreciationPage() {
  ...
  const filteredReviews = () => {
    switch (activeFilter) {
      case "Trust Leaders":   return [...reviews].sort((a, b) => b.trust - a.trust);
      case "Quality Stars":   return [...reviews].sort((a, b) => b.quality - a.quality);
      case "Most Convenient": return [...reviews].sort((a, b) => b.convenience - a.convenience);
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      const newReviewData = await api.createReview(newReview);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {loading ? (
              <div className="text-center py-10 text-sm font-medium" style={{ color: "var(--muted-foreground)" }}>Loading reviews...</div>
